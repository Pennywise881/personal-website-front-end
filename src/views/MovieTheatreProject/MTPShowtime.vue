<template>
    <MTPNavBar />
    <div class="bg-zinc-200 px-2 md:px-20">
        <div class="md:px-10">
            <div class="bg-white rounded overflow-hidden shadow-lg">
                <div class="m-6 max-w-4xl p-6 bg-white border border-gray-300 rounded-lg">
                    ...
                    <div class="flex flex-col md:flex-row">
                        <div class="flex justify-center">
                            ...
                            <div class="flex flex-col">
                                <p class="font-bold uppercase">{{this.movieInfo.title}}</p>
                        ...
                        <div class="mt-5 md:mt-0 md:ml-auto w-28 mb-5 md:mb-10">
                            <a :href="this.movieInfo.rt_link">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/6/6f/Rotten_Tomatoes_logo.svg" alt="rt_link">
                            </a>
                        </div>
                    </div>
                    <div class="mb-10">
                ...
                <section>
                    <div class="mx-6 my-3 flex flex-row">
                    ...
                    <div v-for="(value, name) in this.showTimes" :key="name" class="mx-6 mb-6 max-w-4xl p-6 bg-white border border-gray-300 rounded-lg">
                        ...
                        <div v-for="(timings, date) in value" :key="date">
                            <div v-if="date!=='location'" class="mb-5">
                                <p class="font-bold text-lg">{{this.getFormatedDate(date)}}</p>
                                <hr>
                                <button class="mt-2 md:mt-5 bg-red-600 hover:bg-red-700 text-white text-sm hover:underline font-bold py-1 md:py-2 px-2 md:px-3 rounded mr-3" v-for="t in timings" @click="this.gotoBooking(name, value.location, date, t)">
