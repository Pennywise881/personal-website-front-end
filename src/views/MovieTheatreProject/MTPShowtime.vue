            ...
            <div class="bg-white rounded overflow-hidden shadow-lg">
                ...
                <section>
                    ...
                    <div v-for="(value, name) in this.showTimes" :key="name"
                        class="mx-6 mb-6 max-w-4xl p-6 bg-white border border-gray-300 rounded-lg">
                        ...
                        <div v-for="(timings, date) in value" :key="date">
                            <div v-if="date !== 'location'" class="mb-5">
                                ...
                                <hr>
                                <button
                                    class="mt-2 md:mt-5 bg-red-600 hover:bg-red-700 text-white text-sm hover:underline font-bold py-1 md:py-2 px-2 md:px-3 rounded mr-3"
