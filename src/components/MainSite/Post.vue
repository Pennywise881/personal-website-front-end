<template>
    <div class="container p-5 w-full md:w-4/6 h-screen">
        <div v-for="post in this.posts" class="p-6 bg-white border-2 border-gray-200 rounded-lg shadow-md mb-5">
            ...
            <button :id="post.key+'-expand'" @click="this.expandText(post.key, 'expand')" :class="this.postButtonStyling">
                Read more
    ...
    methods:{
        ...
        {   
            ...
            if(behaviour === 'expand')
            {
                ...
                document.getElementById(post_id+'-collapse').classList=buttonDisplayClass;
            }
