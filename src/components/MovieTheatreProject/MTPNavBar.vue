    ...
    <div class="md:mt-0 py-1 px-20 bg-red-600 flex justify-between">
        <div>
            <p class="hidden md:block text-sm font-bold text-white">
                ...
                <span class="hover:underline cursor-pointer">Offers</span>
            </p>
        </div>
        <div>
            <img src="https://images.fandango.com/cms/assets/b7da0df0-3ebf-11ed-90fe-f325d9bf4959--studio-banner-with-new-wb.png" alt="">
        </div>
    </div>

    <nav class="bg-zinc-900 py-3 px-5 md:px-20">
        <ul class="flex">
            <li>
                <router-link :to="{name:'mtp',}">
                    <img src="../../assets/mtp.svg" alt="logo" class="md:h-16 h-8">
                </router-link>
            </li>
            <li class="ml-auto">
                <!-- Search bar and other links -->
                <div class="flex">
                    ...
                    <div class="grid grid-cols-4 gap-2 text-center">
                        <div class="text-sm md:text-base text-white hover:text-red-600 hover:underline font-bold">
                            ...
                            stroke-width="1.5" 
                            stroke="currentColor" 
                            class="md:h-6 md:w-6 h-4 w-4 m-auto">
