...
const routes = [
    ...
    { path: '/web/movie-theatre-project', name: 'mtp', component: () => import('@/views/MovieTheatreProject/MTP.vue') },
    { path: '/web/movie-theatre-project/showtime/:key/:slug', name: 'Showtime', component: () => import('@/views/MovieTheatreProject/MTPShowtime.vue') },
    { path: '/web/movie-theatre-project/booking', name: 'booking', component: () => import('@/views/MovieTheatreProject/MTPBooking.vue') },
    ...
    { path: '/games/dx-ball', name: 'dx-ball', component: () => import('@/views/DXBall/DXBallHome.vue') },
]
